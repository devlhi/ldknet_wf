                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ url('admin/finance/report/new/customers') }}" class="btn btn-primary d-inline-block"><i class="uil-users-alt"></i> Data Pelanggan Baru</a>
    ...
    <script>
        $(document).ready(function() {
            $("#filterButton").click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/finance/report/new/customers/filter') }}",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        show_data: 1,
                    ...
                    success: function(data) {
                        ...
                        if (typeof data.data === 'string' && data.data === 'No data found') {
                            ...
                            filteredTable.html('<tr><td colspan="4">No data found</td></tr>');
    ...
    <script>
        $(document).ready(function() {
            $("#export").click(function() {
                ...
                var form = $('<form>', {
                    method: 'POST',
                    action: "{{ url('admin/finance/report/new/customers/export') }}",
                    style: 'display:none'
                });
