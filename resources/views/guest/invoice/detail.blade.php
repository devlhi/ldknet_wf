...
<body>
    ...
    @foreach ($content as $row)
        @php $dataweb = $website->first(); $datacomp = $company->first(); @endphp
                    ...
                    <div class="tm_invoice_in">
                        <div class="tm_invoice_head tm_mb20 tm_m0_md">
                            <div class="tm_invoice_left">
                                <div class="tm_logo"><img src="{{ asset('assets/logo/'.($dataweb->logo ?? '')) }}" width="170" crossorigin="anonymous" alt="Logo"></div>
                            </div>
                            <div class="tm_invoice_right">
                                <div class="tm_grid_row tm_col_3">
                                    ...
                                    <div class="tm_text_center">
                                        ...
                                        {{ $datacomp->city ?? '' }}
                                        <br>
                                        {{ $datacomp->country ?? '' }}, {{ $datacomp->postal_code ?? '' }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tm_invoice_info tm_mb30 tm_align_center">
                            <div class="tm_invoice_info_left tm_mb20_md">
                                <p class="tm_mb0">
                                    <b class="tm_primary_color">Nomor Invoice: </b><br /> {{ $row->code }} <br>
                                    <input type="hidden" id="nameinvoice" value="{{ $row->code }}">
                                    <b class="tm_primary_color">Tanggal Faktur: </b><br />{{ tanggal_indo($row->date) }}
                                </p>
                            </div>
                                    ...
                                    <div>
                                        @php
                                            if ($row->status == 'Unpaid') {
                                                $text = 'BELUM TERBAYAR'; $color = 'danger';
                                            } elseif ($row->status == 'Paid') {
                                                $text = 'SUDAH TERBAYAR'; $color = 'success';
                                            } elseif ($row->status == 'Error') {
                                                $text = 'DIBATALKAN OLEH SISTEM'; $color = 'danger';
                                            } else {
                                                $text = strtoupper($row->status ?? '-'); $color = 'danger';
                                            }
                                        @endphp
                                        <b class="tm_accent_color tm_f26 tm_medium tm_{{ $color }}_color">{{ $text }}</b>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="tm_width_6 tm_border_top_0">
                                                    <b class="tm_primary_color tm_medium">Nama Pelanggan : </b>{{ $row->nama }}
                                                </td>
                                                <td class="tm_width_6 tm_border_top_0 tm_border_left tm_accent_border_20">
                                                    <b class="tm_primary_color tm_medium">ID Pelanggan : </b>{{ $row->idpel }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="tm_border tm_accent_border_20">
                                <div class="tm_table_responsive">
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="tm_width_3 tm_accent_border_20">{{ $row->package }} </td>
                                                <td class="tm_width_4 tm_accent_border_20 tm_text_right">{{ tgl_indo($row->expdate) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="tm_mb15 tm_m0_md">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_medium">Rp {{ number_format($row->price) }}</td>
                                            </tr>
                                            <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Pajak 11%</td>
                                            <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">+ Rp 0 </td>
                                            <tr class="tm_accent_border_20 tm_border">
                                                ...
                                                <td class="tm_width_3 tm_bold tm_f16 tm_border_top_0 tm_accent_color tm_text_right tm_accent_bg_10">Rp {{ number_format($row->price) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
