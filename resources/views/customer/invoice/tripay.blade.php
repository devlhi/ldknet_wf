        ...
        <div class="row p-2 m-1 rounded bg-light mob1 shadow-lg">
            <div class="d-flex justify-content-between mb-2">
                ...
                <div class="text-right" style="margin-top: auto;margin-bottom: auto;">
                    @if (! empty($payment->data[0]->icon_url))
            ...
            <div class="col-md-7 col-lg-12 mt-2">
                <ul class="list-group mb-3">
                    ...
                    @elseif (! empty($tripay->data->pay_code) && $tripay->data->status == 'UNPAID')
                        <li class="list-group-item">
                            <div>
                    ...
                    @elseif (! empty($tripay->data->pay_url) && $tripay->data->status == 'UNPAID')
                        <li class="list-group-item">
                            <div class="w-100 d-flex justify-content-center">
                                <a href="{{ $tripay->data->pay_url }}" target="_blank" rel="noopener" class="btn btn-primary w-100">Lanjutkan Pembayaran</a>
                            </div>
                        </li>
                    @endif
            ...
            <div class="d-flex justify-content-center gap-2">
                @if (! empty($tripay->data->instructions))
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h7 class="modal-title" id="exampleModalLabel">Petunjuk Pembayaran {{ $tripay->data->payment_name }}</h7>
                    </div>
