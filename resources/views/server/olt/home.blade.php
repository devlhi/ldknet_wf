            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Managemen OLT</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    @if (auth()->user()->level === 'developer')
                        <div>
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-3" data-bs-toggle="modal" data-bs-target="#myModal"><i class="mdi mdi-plus me-1"></i> Add OLT</button>
                        </div>
                    @endif
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="float-left">
                                                <h6 class="modal-title" id="custom-width-modalLabel">Tambah data olt</h6>
                                            </div>
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" action="{{ url('server/olt/add') }}" role="form" method="POST">
                                                @csrf

                                                <div class="form-group">
                                                    <label class="col-md-2 control-label"> Nama</label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="nama" class="form-control" placeholder="OLT A">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">IP / Host</label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="host" class="form-control" placeholder="Masukan IP Address OLT">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                            ...
                            @if (! ($dataLoaded ?? true))
                                <div class="alert alert-info d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <span><i class="mdi mdi-information-outline me-2"></i> Data OLT belum dimuat dari database. Klik tombol untuk memuat data.</span>
                                ...
                                <tbody>
                                    @foreach ($getData as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('server/olt/connect/' . $row->id) }}" class="btn btn-sm btn-success"><i class='uil uil-link'></i> Connect</a>

                                                @if (auth()->user()->level === 'developer')
                                                    <a href="{{ url('server/olt/edit/' . $row->id) }}" class="btn btn-sm btn-primary"><i class='uil uil-edit'></i> Edit</a>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-primary" href="{{ url('server/olt/delete/' . $row->id) }}">Yes</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
