...
// Rename dari encrypt(): bentrok dengan helper global Laravel.
// Tetap dipakai untuk membaca password router lama di DB.
function legacy_encrypt($string, $key = 128)
{
    $result = '';
...
function legacy_decrypt($string, $key = 128)
{
    $result = '';
