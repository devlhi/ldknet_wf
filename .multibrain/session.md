...
- `wa-gateway` — WhatsApp gateway (lama + Meta Official) & template — update: 2026-07-15 23:06 WIB (audit fix: timestamp/tick/draft/polling/race/partial-fail) -> .multibrain/indexes/wa-gateway.md
