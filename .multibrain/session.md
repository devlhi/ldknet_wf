...
- `wa-gateway` — WhatsApp gateway (lama + Meta Official) & template — update: 2026-07-12 19:12 WIB (admin reply text terverifikasi + response hardening) -> .multibrain/indexes/wa-gateway.md
